...
TACTICS = ["TA0002", "TA0005", "TA0004"]
RTA_ID = "cfb116f0-ad83-4d77-803f-064c2cfd93fe"
...
def main():
    ...
    # Create Dir
    common.execute(
        [powershell, "/c", f"New-Item -Path {dccwpath} -Type Directory"], timeout=10
    )
    common.copy_file(EXE_FILE, dccwpathdll)
    common.execute(
        [dllhost, "/c", f"Rename-Item {dccwpathdll} {dccwpathdll2}"], timeout=10
    )
