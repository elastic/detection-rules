...
TRIGGERED_RULES = {
    ...
    "ENDPOINT": [
        ...
        {
            "rule_name": "Startup Persistence via Unusual Process",
            "rule_id": "95d13ce1-ffb2-4be8-a56e-cc9a891e81e2",
        },
        {
...
TACTICS = ["TA0003", "TA0005", "TA0002"]
RTA_ID = "9a0c0715-5225-4170-a505-0e3cc4dfd63e"
...
def main():
    ...
    posh = (
        "C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\posh.exe"
    )
