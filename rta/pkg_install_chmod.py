...
metadata = RtaMetadata(
    ...
    endpoint=[
        ...
        {"rule_name": "Suspicious File Create via Pkg Install Script", "rule_id": "f06d9987-33f8-44b7-b815-c1f66fb39d25"},
    ],
    siem=[],
...
def main():
    ...
    with common.temporary_file("testing", source_file):
        common.execute([masquerade, "childprocess", command, "childprocess",
                        f"cp {source_file} {dest_file}", "childprocess", "/tmp/PKInstallSandbox.*/Scripts/*/postinstall"],
