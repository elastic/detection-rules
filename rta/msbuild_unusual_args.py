...
TRIGGERED_RULES = {
    ...
    "ENDPOINT": [
        ...
        {
            "rule_name": "MSBuild with Unusual Arguments",
            "rule_id": "6518cdaf-e6cd-4cf9-a51e-043117c3dbeb",
        },
    ],
}
TACTICS = ["TA0005"]
RTA_ID = "511278ac-4996-438e-ba03-bef8f10665b5"
...
def main():
    ...
    common.execute(
        [rcedit, msbuild, "--set-version-string", "OriginalFilename", "MSBuild.exe"]
    )
