...
- [Drivers Load with Low Occurrence Frequency](./linux/docs/drivers_load_with_low_occurrence_frequency.md) (ES|QL)
...
- [Hidden Process Execution](./linux/docs/hidden_process_execution.md) (ES|QL)
...
- [Network Connections with Low Occurrence Frequency for Unique Agent ID](./linux/docs/network_connections_with_low_occurrence_frequency_for_unique_agents.md) (ES|QL)
- [Git Hook/Pager Persistence](./linux/docs/persistence_git_hook_pager.md) (ES|QL)
...
- [Persistence via Packager Manager](./linux/docs/persistence_via_package_manager.md) (ES|QL)
- [Persistence via rc.local](./linux/docs/persistence_via_rc_local.md) (ES|QL)
...
- [Segmentation Fault & Potential Buffer Overflow Hunting](./linux/docs/segmentation_fault_and_buffer_overflow.md) (ES|QL)
- [Shell Modification Persistence](./linux/docs/shell_modification_persistence.md) (ES|QL)
- [Uncommon Process Execution from Suspicious Directory](./linux/docs/uncommon_process_execution_from_suspicious_directory.md) (ES|QL)
- [Unusual File Creations by Web Server User](./linux/docs/unusual_file_creations_by_web_server_user.md) (ES|QL)
- [Unusual File Downloads from Source Addresses](./linux/docs/unusual_file_downloads_from_source_addresses.md) (ES|QL)
- [Unusual Process Command Lines for Web Server User](./linux/docs/unusual_process_command_lines_for_web_server_user.md) (ES|QL)
- [Unusual System Binary Parent (Potential System Binary Hijacking Attempt)](./linux/docs/unusual_system_binary_parent.md) (ES|QL)
- [Privilege Escalation via User/Group Creation and/or Modification](./linux/docs/user_group_creation_modification.md) (SQL)
