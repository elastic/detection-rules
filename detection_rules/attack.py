...
def refresh_attack_data(save=True) -> (Optional[dict], Optional[bytes]):
    ...
    current_version = semver.VersionInfo(*get_version_from_tag(filename, 'attack-v').split("."))
    ...
    latest_version = semver.VersionInfo(*get_version_from_tag(release_name).split("."))
