...
def single_collection(f):
    ...
    def get_collection(*args, **kwargs):
        ...
        if rule_id:
            rules.load_directory(DEFAULT_RULES_DIR, toml_filter=dict_filter(rule__rule_id=rule_id)) or \
                rules.load_directory(DEFAULT_BBR_DIR, toml_filter=dict_filter(rule__rule_id=rule_id))
