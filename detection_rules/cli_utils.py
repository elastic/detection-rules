...
from .rule_loader import RuleCollection, DEFAULT_RULES_DIR, dict_filter, DEFAULT_BBR_DIR
...
def single_collection(f):
    ...
    def get_collection(*args, **kwargs):
        ...
        if rule_id:
            ...
            rules.load_directory(DEFAULT_BBR_DIR, toml_filter=dict_filter(rule__rule_id=rule_id), recursive=False)
