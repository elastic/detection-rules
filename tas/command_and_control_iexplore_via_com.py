...
metadata = RtaMetadata(
    ...
    platforms=["windows"],
    endpoint=[],
    siem=[{'rule_id': 'acd611f3-2b93-47b3-a0a3-7723bcc46f6d', 'rule_name': 'Potential Command and Control via Internet Explorer'}],
    techniques=[""],
)
...
def main():
    ...
    common.execute([iexplore, "/c", f"Test-NetConnection -ComputerName google.com -Port 443"], timeout=10)
