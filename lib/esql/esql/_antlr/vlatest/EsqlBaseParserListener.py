# Generated from /var/folders/34/52r9fr3x7kgcv2srt4rgpmcc0000gn/T//esql-gen-latest.5Wb8Cl/adapted/EsqlBaseParser.g4 by ANTLR 4.13.1
from antlr4 import *
if "." in __name__:
...
class EsqlBaseParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by EsqlBaseParser#denseVectorCommand.
    def enterDenseVectorCommand(self, ctx:EsqlBaseParser.DenseVectorCommandContext):
        pass

    # Exit a parse tree produced by EsqlBaseParser#denseVectorCommand.
    def exitDenseVectorCommand(self, ctx:EsqlBaseParser.DenseVectorCommandContext):
        pass


    # Enter a parse tree produced by EsqlBaseParser#denseVectorTargetName.
    def enterDenseVectorTargetName(self, ctx:EsqlBaseParser.DenseVectorTargetNameContext):
        pass

    # Exit a parse tree produced by EsqlBaseParser#denseVectorTargetName.
    def exitDenseVectorTargetName(self, ctx:EsqlBaseParser.DenseVectorTargetNameContext):
        pass


    # Enter a parse tree produced by EsqlBaseParser#denseVectorSuffix.
    def enterDenseVectorSuffix(self, ctx:EsqlBaseParser.DenseVectorSuffixContext):
        pass

    # Exit a parse tree produced by EsqlBaseParser#denseVectorSuffix.
    def exitDenseVectorSuffix(self, ctx:EsqlBaseParser.DenseVectorSuffixContext):
        pass


    # Enter a parse tree produced by EsqlBaseParser#denseVectorLiteralInput.
    def enterDenseVectorLiteralInput(self, ctx:EsqlBaseParser.DenseVectorLiteralInputContext):
        pass

    # Exit a parse tree produced by EsqlBaseParser#denseVectorLiteralInput.
    def exitDenseVectorLiteralInput(self, ctx:EsqlBaseParser.DenseVectorLiteralInputContext):
        pass
    ...
    # Enter a parse tree produced by EsqlBaseParser#logicalInMultiColumnSubquery.
    def enterLogicalInMultiColumnSubquery(self, ctx:EsqlBaseParser.LogicalInMultiColumnSubqueryContext):
        pass

    # Exit a parse tree produced by EsqlBaseParser#logicalInMultiColumnSubquery.
    def exitLogicalInMultiColumnSubquery(self, ctx:EsqlBaseParser.LogicalInMultiColumnSubqueryContext):
        pass
    ...
    # Enter a parse tree produced by EsqlBaseParser#lambda.
    def enterLambda(self, ctx:EsqlBaseParser.LambdaContext):
        pass

    # Exit a parse tree produced by EsqlBaseParser#lambda.
    def exitLambda(self, ctx:EsqlBaseParser.LambdaContext):
        pass
