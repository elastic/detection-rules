...
class EsqlBaseParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by EsqlBaseParser#denseVectorCommand.
    def visitDenseVectorCommand(self, ctx:EsqlBaseParser.DenseVectorCommandContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by EsqlBaseParser#denseVectorTargetName.
    def visitDenseVectorTargetName(self, ctx:EsqlBaseParser.DenseVectorTargetNameContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by EsqlBaseParser#denseVectorSuffix.
    def visitDenseVectorSuffix(self, ctx:EsqlBaseParser.DenseVectorSuffixContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by EsqlBaseParser#denseVectorLiteralInput.
    def visitDenseVectorLiteralInput(self, ctx:EsqlBaseParser.DenseVectorLiteralInputContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by EsqlBaseParser#logicalInMultiColumnSubquery.
    def visitLogicalInMultiColumnSubquery(self, ctx:EsqlBaseParser.LogicalInMultiColumnSubqueryContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by EsqlBaseParser#lambda.
    def visitLambda(self, ctx:EsqlBaseParser.LambdaContext):
        return self.visitChildren(ctx)
