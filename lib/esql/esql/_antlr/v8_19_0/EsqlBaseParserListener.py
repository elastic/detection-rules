...
class EsqlBaseParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by EsqlBaseParser#metadataOption.
    def enterMetadataOption(self, ctx:EsqlBaseParser.MetadataOptionContext):
        pass

    # Exit a parse tree produced by EsqlBaseParser#metadataOption.
    def exitMetadataOption(self, ctx:EsqlBaseParser.MetadataOptionContext):
        pass


    # Enter a parse tree produced by EsqlBaseParser#deprecated_metadata.
    def enterDeprecated_metadata(self, ctx:EsqlBaseParser.Deprecated_metadataContext):
        pass

    # Exit a parse tree produced by EsqlBaseParser#deprecated_metadata.
    def exitDeprecated_metadata(self, ctx:EsqlBaseParser.Deprecated_metadataContext):
        pass
