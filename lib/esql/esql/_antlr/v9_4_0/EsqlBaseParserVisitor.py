# Generated from /var/folders/34/52r9fr3x7kgcv2srt4rgpmcc0000gn/T//esql-gen-9.4.0.FBYqYY/adapted/EsqlBaseParser.g4 by ANTLR 4.13.1
from antlr4 import *
if "." in __name__:
...
class EsqlBaseParserVisitor(ParseTreeVisitor):
    ...
    def visitInsistCommand(self, ctx:EsqlBaseParser.InsistCommandContext):
        return self.visitChildren(ctx)
