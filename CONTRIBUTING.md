...
The current metadata that is captured in a rule file consists of:
...
```
Rule Telnet Port Activity saved to /Users/seven62/code/detection-rules/telnet_port_activity.toml
...
After import, you can check the syntax and validate new rules.
